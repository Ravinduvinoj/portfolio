...
const projects = [
  {
    title: "BillGo – Sales Billing Management App",
    description: "A comprehensive sales billing management system with real-time collaboration, Shop Management and multi-channel invoicing.",
  ...
  {
    title: "GreenJobs – Job Portal",
    description: "A job portal focused on sustainability and green energy careers, Job seeker app, company profiles, and career resources.",
    tags: ["Angular", "Node.js", "MongoDB", "Typescript", "Tailwind", "Flutter", "Dart"],
    category: "Web App",
    featured: true,
    github: "",
    live: "",
